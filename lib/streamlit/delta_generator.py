...
class DeltaGenerator(
    ...
    def _block(self, block_proto=Block_pb2.Block()) -> "DeltaGenerator":
        ...
        # Comment out to allow us to use nested expanders
        # See https://leadiq.slack.com/archives/C024BTDFUG4/p1635842645017100
        # https://github.com/streamlit/streamlit/issues/3344
